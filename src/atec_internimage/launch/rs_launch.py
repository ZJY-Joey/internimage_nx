...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rs_d455', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "_049122250759", 'description': 'choose device by serial number'},
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    # )
    lifecycle_param_file = os.path.join(get_package_share_directory("atec_internimage"),"config","global_settings.yaml")
    
    # PathJoinSubstitution([
        # FindPackageShare("atec_internimage"), "config", "global_settings.yaml"
    # ])
