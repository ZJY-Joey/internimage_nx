...
class InternImageNode(Node):
    def __init__(self):
        ...
        self.color_seg_pub = self.create_publisher(Image, self.color_segmentation_topic)
        self.id_seg_pub = self.create_publisher(Image, self.id_segmentation_topic)
        self.combined_seg_pub = self.create_publisher(CompressedImage, self.combined_segmentation_topic)
